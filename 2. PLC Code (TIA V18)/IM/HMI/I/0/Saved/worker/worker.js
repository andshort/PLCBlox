...
async function evalInContext(id, code) {
    ...
    let Screen = createProxy(id, id, [
        'ScreenNumber', 'ScreenMaster', 'CurrentStyle', 'EnableExplicitUnlock', 'Authorization', 'Operability', 'RequireExplicitUnlock', 'Enabled', 'Width', 'Height',
    ...
    let methods = {
        register: async function (id, code) {
            ...
            try {
                ...
                console.log('Registered some code');
                return true;
            } catch(ex) {};
